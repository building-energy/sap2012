...
class Sap2012():
    ...
    SAP2012 is the Standard Assessment Procedure 2012, the UK Government's 
    energy calculation method for the building regulation compliance for 
    new dwellings. 
    
    SAP2012 is developed and published by the Building Research Establishment.
    
    See: https://www.bregroup.com/sap/standard-assessment-procedure-sap-2012/
    
    A Sap2012 instance contains two attributes:
        
        - *inputs*: a dictionary of the inputs needed for the SAP calculation.
        ...
        - *outputs*: a dictionary of the outputs generated by a successful SAP calculation run.
    ...
    A SAP calcuation is run by using the *run* method.
    ...
    def read_input_csv(self,fp):
        """Reads an input csv file and places the values in the self.input dictionary.
    ...
    def read_input_json(self,fp):
        """Reads an inputs json file and places the values in the self.input dictionary.
        
        An input json file is formatted as a dictionary like object matching the 
        format of the self.input dictionary.
    ...
    def run(self):
        ...
        The function runs each of the individual calculation sections in turn.
    ...
    def write_input_csv(self,fp):
        """Writes the inputs stored in the self.inputs dictionary as a csv file.
    ...
    def write_input_json(self,fp):
        """Writes the inputs stored in the self.inputs dictionary as a json file.
